...
class FeedBackModel(nn.Module):
    def __init__(self, model_name,layer_start):
        ...
        #-----------------
        self.pooler = WeightedLayerPooling(self.config.num_hidden_layers,layer_start=layer_start, layer_weights=None)
    ...
    def forward(self, ids, mask, token_type_ids=None, targets=None):
        ...
        all_hidden_state=transformer_out[1]
        ...
        sequence_output=weighted_pooling_embeddings
        # Main task
...
if __name__ == '__main__':
    ...
    for fold in range(0, CONFIG['n_fold']):
        ...
        model = FeedBackModel(CONFIG['model_name'],layer_start=9)
