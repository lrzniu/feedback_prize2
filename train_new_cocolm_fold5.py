...
CONFIG = {"seed": 42,
          "epochs": 3,
          "model_name": "microsoft/cocolm-base",
          "train_batch_size": 1,
          "valid_batch_size": 2,
          "max_length": 512,
          "learning_rate": 1e-5,
...
class FeedBackModel(nn.Module):
    def __init__(self, model_name):
        ...
        self.cfg = CONFIG
        COCOLMModel.supported_convert_pretrained_model_archive_map['cocolm'][
            'microsoft/cocolm-base'] = 'cocolm-base/pytorch_model.bin'
        COCOLMPreTrainedModel.supported_convert_pretrained_model_archive_map['cocolm'][
            'microsoft/cocolm-base'] = 'cocolm-base/pytorch_model.bin'
        self.config = COCOLMConfig.from_pretrained(model_name)
        self.model = COCOLMModel.from_pretrained("microsoft/cocolm-base", config=self.config, local_files_only=True)
