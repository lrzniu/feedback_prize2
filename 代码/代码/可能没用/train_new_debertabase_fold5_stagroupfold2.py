...
df1=df_train[df.discourse_effectiveness=='Adequate'].reset_index(drop=True)
df2=df_train[df.discourse_effectiveness=='Effective'].reset_index(drop=True)
df3=df_train[df.discourse_effectiveness=='Ineffective'].reset_index(drop=True)
# %%
