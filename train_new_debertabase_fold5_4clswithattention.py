...
class FeedBackModel(nn.Module):
    ...
    def forward(self, ids, mask, token_type_ids=None, targets=None):
        ...
        sequence_output1 = concatenate_pooling[:, 0]
        weights = self.attention(sequence_output1)
        sequence_output2 = torch.sum(weights * sequence_output1, dim=1)
        sequence_output=torch.cat((sequence_output2, sequence_output1), -1)
        # simple CLS
