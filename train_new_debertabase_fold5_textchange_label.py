...
df2 = pd.read_csv("pseudolabel_output_same.csv")
df2 = df2.loc[:, ['discourse_id', 'essay_id', 'discourse_text', 'discourse_type', 'discourse_effectiveness','essay_text']]
df['essay_text'] = df['essay_id'].apply(get_essay)
df_sample=df2[0:df.shape[0]//4]#取相当于原数据集的四分之一
