...
# df.head()
Fold = StratifiedKFold(n_splits=CONFIG['n_fold'], shuffle=True, random_state=CONFIG['seed'])#StratifiedGroupKFold
...
class FeedBackModel(nn.Module):
    ...
    def forward(self, ids, mask, token_type_ids=None, targets=None):
        ...
        poolout = self.pooler(transformer_out.last_hidden_state, mask)
        out = self.dropout(poolout)
